...
""";
	...
	def startIOS(self):
		...
		if (self.building_library):
			...
			try:
				util.makeDirectories([self.game_dir + self.ds + self.build_folder + self.ds + self.output]);
				util.makeDirectories([self.game_dir + self.ds + self.build_folder + self.ds + self.output + self.ds + "data"]);
				util.makeDirectories([self.game_dir + self.ds + self.build_folder + self.ds + self.output + self.ds + "build-cache"]);
